...
export const CARS_DATABASE: CarData[] = [
  {
    ...
    specs: {
      ...
      power: 1800, // Combined HP (1000hp engine + 800hp electric)
      torque: 1475, // lb-ft combined est
      redline: 9000,
...
This is an analog, mechanical monument built to stand the test of centuries.`
  ...
  },
  {
    ...
    specs: {
      ...
      power: 1600, // On E85 fuel (1280 on pump gas)
      torque: 1106,
      redline: 8500,
